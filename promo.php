...
<div class="content-section" >
  <div class="container">
    ...
    <strong>PMS PROMO! <br> For IPMAN SULEJA MARKETERS</strong> IN A.A RANO AT PRICE <B> NGN 132</B>.
  </div>
  <div class="alert alert-info fade in">
    
    <strong>AGO PROMO! <br> For IPMAN SULEJA MARKETERS</strong> IN A.A RANO AT PRICE <B> NGN 132</B>.
  </div>
  <div class="alert alert-warning fade in">
    
    <strong>DPK PROMO! <br> For IPMAN SULEJA MARKETERS</strong> IN A.A RANO AT PRICE <B> NGN 132</B>.
  </div>
  <div class="alert alert-danger fade in">
    
    <strong>SRG PROMO! <br> For IPMAN SULEJA MARKETERS</strong> IN A.A RANO AT PRICE <B> NGN 132</B>.
  </div>
    </div>
  </div>
</div>
